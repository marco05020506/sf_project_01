...
def random_predict(number: int=1) -> int:
    ...
    while True:
        ...
        # Предполагаемое число как целочисленная середина отрезка
        ...
        if predict_number == number:
            ...
            # Уменьшаем отрезок вдвое сдвинув к середине нижний конец отрезка
            a = predict_number  
            
        else:
            # Уменьшаем отрезок вдвое сдвинув к середине верхний конец отрезка
            b = predict_number  
